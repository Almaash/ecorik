...
import executive from '../Img/executive-room.jpg'
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-title">Executive Room Detail</h5>
                        </div>
                        <div class="card-body">
                            
                            <p class="card-text">Spaciously built and tastefully furnished,Executive rooms come equipped with all modern amenities to make your stay comfortable. Executive Suites also feature an LCD television, an electronic safe and Free high speed, wireless Internet.</p>
